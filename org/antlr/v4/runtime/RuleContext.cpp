...
#include "Java/src/org/antlr/v4/runtime/tree/gui/TreeViewer.h"
...
ParserRuleContext *const RuleContext::EMPTY = new ParserRuleContext();
                ...
                org::antlr::v4::runtime::misc::Interval *RuleContext::getSourceInterval() {
                    return Interval::INVALID;
                }

                org::antlr::v4::runtime::RuleContext *RuleContext::getRuleContext() {
                    return this;
                }

                org::antlr::v4::runtime::RuleContext *RuleContext::getParent() {
                    return parent;
                }

                org::antlr::v4::runtime::RuleContext *RuleContext::getPayload()
                /// <summary>
...
template<typename T, typename T1> where T1 : T
                T RuleContext::accept(ParseTreeVisitor<T1> *visitor) {
                ...
                void RuleContext::save(Parser *parser, const std::wstring &fileName) throw(IOException, PrintException) {
                    std::vector<std::wstring> ruleNames = parser != nullptr ? Arrays::asList(parser->getRuleNames()) : nullptr;
                    save(ruleNames, fileName);
                }

                void RuleContext::save(Parser *parser, const std::wstring &fileName, const std::wstring &fontName, int fontSize) throw(IOException) {
                    std::vector<std::wstring> ruleNames = parser != nullptr ? Arrays::asList(parser->getRuleNames()) : nullptr;
                    save(ruleNames, fileName, fontName, fontSize);
                }

                void RuleContext::save(std::vector<std::wstring> &ruleNames, const std::wstring &fileName) throw(IOException, PrintException) {
